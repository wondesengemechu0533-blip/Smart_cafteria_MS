...
export const translations = {
  en: {
    ...
    // ===== DELIVERY STAFF =====
    delivery_brand: "Smart Cafeteria",
    delivery_brand_delivery: "Delivery",
    delivery_role: "Delivery Staff",
    delivery_logout: "Logout",
    delivery_main: "MAIN",
    delivery_operations: "DELIVERIES",
    delivery_account: "ACCOUNT",
    delivery_dashboard: "Dashboard",
    delivery_active_deliveries: "Active Deliveries",
    delivery_history: "My History",
    delivery_notifications: "Notifications",
    delivery_profile: "Profile",
    delivery_dashboard_page_title: "Delivery Dashboard - Smart Cafeteria",
    delivery_deliveries_page_title: "Active Deliveries - Smart Cafeteria",
    delivery_history_page_title: "My Delivery History - Smart Cafeteria",
    delivery_notifications_page_title: "Notifications - Smart Cafeteria",
    delivery_profile_page_title: "My Profile - Smart Cafeteria",
  ...
  am: {
    ...
    confirm_delete_user: 'ተጠቃሚ "{name}" ይቦዝዩ? ከአሁን በኋላ መግባት አይችሉም።',
...
kitchen_no_orders: "No orders at the moment",
    kitchen_new_order_sound: "New Order Alert",
    delivery_brand: "ስማርት ካፌቴሪያ",
    delivery_brand_delivery: "ማድረስ",
    delivery_role: "የማድረስ ሰራተኛ",
    delivery_logout: "ውጣ",
    delivery_main: "ዋና",
    delivery_operations: "ማድረሶች",
    delivery_account: "መለያ",
    delivery_dashboard: "ዳሽቦርድ",
    delivery_active_deliveries: "ንቁ ማድረሶች",
    delivery_history: "የማድረስ ታሪኬ",
    delivery_notifications: "ማስታወቂያዎች",
    delivery_profile: "መገለጫዬ",
    delivery_dashboard_page_title: "የማድረስ ዳሽቦርድ - ስማርት ካፌቴሪያ",
    delivery_deliveries_page_title: "ንቁ ማድረሶች - ስማርት ካፌቴሪያ",
    delivery_history_page_title: "የማድረስ ታሪኬ - ስማርት ካፌቴሪያ",
    delivery_notifications_page_title: "ማስታወቂያዎች - ስማርት ካፌቴሪያ",
    delivery_profile_page_title: "መገለጫዬ - ስማርት ካፌቴሪያ",
    required_field: "Required",
    optional_field: "Optional",
    select_option: "Select an option",
    yes: "Yes",
  ...
  om: {
    ...
    // ===== ADMIN USERS (Afaan Oromoo) =====
    admin_users_page_title: "Meeshalee Balaa'ummaa - Smart Cafeteria",
    admin_users_title: "Meeshalee Balaa'ummaa",
    admin_users_subtitle: "Balaa'ummaa hunda sirna keessa qindeessii",
    admin_user_search: "Balaa'ummaa barbaadi...",
    add_user: "Balaa'ummaa Dabali",
    edit_user: "Balaa'ummaa Gombisi",
    view_details: "Ballinaa Dubbisi",
    change_role: "Gahee Jijjiiri",
    change_role_for: "Gahee jijjiiri of",
    reset_password: "Jechaa Ibsaa Debisee Qindeessi",
    reset_password_for: "Jechaa ibsaa debisee qindeessi of",
    reset_password_btn: "Jechaa Ibsaa Debisee Qindeessi",
    change_status: "Haala Herregaa Jijjiiri",
    change_status_for: "Haala herregaa jijjiiri of",
    save_role: "Gahee Qoodsi",
    save_status: "Haala Qoodsi",
    saving: "Qoodsuuf jiru",
    all_users: "Balaa'ummaa Hunda",
    all_roles: "Gahee Hunda",
    all_status: "Haala Hunda",
    user_col_user: "Balaa'ummaa",
    user_col_role: "Gahee",
    user_col_balance: "Qilleensa",
    user_col_status: "Haala",
    user_col_joined: "Seene",
    user_col_actions: "Gochaalee",
    user_details: "Ballinaa Balaa'ummaa",
    user_id: "ID Balaa'ummaa",
    email_address: "Adeesa Imeelii",
    phone_number: "Lakkoofsa Bilbilaa",
    phone_hint: "Bilbilaa (09XXXXXXXX)",
    wallet_balance: "Qilleensa Wallet (Birr)",
    joined: "Seene",
    role_customer: "Balaa'ummaa",
    role_kitchen: "Hojjetaa Mana Caccabsaa",
    role_delivery: "Hojjetaa Dhaamii",
    role_staff: "Hojiimmaa",
    role_student: "Baraa Barreessaa",
    role_admin: "Haadhaa",
    status_active: "Naqqa",
    status_blocked: "Cufame",
    status_suspended: "Hakiiname",
    status_inactive: "Hojii Irraa Bahe",
    new_password: "Jechaa Ibsaa Haaraa",
    new_password_optional: "Jechaa Ibsaa Haaraa (wardii qofaa hin jiraatu)",
    confirm_password: "Jechaa Ibsaa Hundaa Hubadhu",
    total_users: "Balaa'ummaa Dhibeeye",
    active_students: "Balaa'ummaa Naqqaan",
    staff: "Hojiitoota",
    blocked_users: "Balaa'ummaa Cufaman",
    password_required_new: "Jechaa Ibsaa balaa'ummaa haaraatiif barbaachisa",
    user_saved: "Balaa'ummaa baga gombitu",
    failed_save_user: "Balaa'ummaa qoodsuu dadhabe",
    user_not_found: "Balaa'ummaa hin argame",
    role_updated: "Gahee baga qoodame",
    failed_role: "Gahee qoodsuu dadhabe",
    status_updated: "Haala baga qoodame",
    failed_status: "Haala qoodsuu dadhabe",
    password_min_6: "Jechaan ibsaan waggaa 6 ta'uu qaba",
    passwords_no_match: "Jechaan ibsaa wal hin simnu",
    password_reset_success: "Jechaan ibsaa baga qindeefame",
    failed_password_reset: "Jechaa ibsaa qindeessuu dadhabe",
    user_deactivated: "Balaa'ummaa baga cuftu",
    failed_delete: "Balaa'ummaa cufuu dadhabe",
    confirm_delete_user: "Balaa'ummaa \"{name}\" cuftuu? Amma irraa seenuu hin danda'u.",
    cannot_deactivate_own: "Herrega kee ofii cufuu hin dandeessu",
    page_info: "Fuula {page} keessaa {pages} ({total} bala'a)",
  }
};
